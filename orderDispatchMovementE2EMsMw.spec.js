...
describe('Order-dispatch-movement synchronization MailShip-MailWise E2E test', () => { //[MW-1443, MW-1471, MW-1486, MW-1557, MW-1706]
    ...
    it.skip('Should add product from location to parcel in MailWrap', {
        retries
    }, () => {
        const variables = {
            id: parcelId,
    ...
    it.skip('Should finish a parcel in MailWrap', {
        retries
    }, () => {
        const variables = {
            id: parcelId
    ...
    it.skip('Should check a parcel for dispatch in MailWrap', {
        retries
    }, () => {
        skipOn(isDev());
        const variables = {
